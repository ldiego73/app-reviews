...
const appstore = require("./app_store_reviews.js");
const googlePlay = require("./google_play_reviews.js");
const fs = require("fs");
...
exports.postToTeams = function (message, config) {
    var messageJSON = JSON.stringify(message);
    if (config.verbose) {
        console.log("INFO: Posting new message to Teams: ");
        console.log("INFO: Hook: " + config.teamHook);
        console.log("INFO: Message: " + messageJSON);
    }
